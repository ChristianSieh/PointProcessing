...
imageMenu("Point Processes",
  {
    ...
    {"Brightness", pointProc.posterize, {{name = "levels", type = "number", displaytype = "spin", default = 8, min = 2, max = 64}}},
    {"Brightness - Weiss", il.posterize, {{name = "levels", type = "number", displaytype = "spin", default = 8, min = 2, max = 64}}},
...
imageMenu("Histogram processes",
  {
    ...
    {"Histogram Display", hist.histDisplay},
